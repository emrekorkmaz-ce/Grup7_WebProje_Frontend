...
export const GraduationCapIcon = ({ size = 20, color = 'currentColor', ...props }) => ( <
    svg width = { size }
    height = { size }
    viewBox = "0 0 24 24"
    fill = "none"
...
export const MegaphoneIcon = ({ size = 20, color = 'currentColor', ...props }) => ( <
    svg width = { size }
    height = { size }
    viewBox = "0 0 24 24"
    fill = "none"
    ...
    strokeLinejoin = "round" {...props } >
    <
    path d = "M3 11l8-5v12l-8-5v-2z" > < /path> <
    path d = "M11 6c6-2 9 0 9 5s-3 7-9 5" > < /path> <
    path d = "M3 11V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v7" > < /path> <
    /svg>
);
...
export const BuildingIcon = ({ size = 20, color = 'currentColor', ...props }) => ( <
    svg width = { size }
    height = { size }
    viewBox = "0 0 24 24"
    fill = "none"
...
export const XCircleIcon = ({ size = 20, color = 'currentColor', ...props }) => ( <
    svg width = { size }
    height = { size }
    viewBox = "0 0 24 24"
    fill = "none"
...
export const SparklesIcon = ({ size = 20, color = 'currentColor', ...props }) => ( <
    svg width = { size }
    height = { size }
    viewBox = "0 0 24 24"
    fill = "none"
